...
# @File     : turn_trade.py
# @Function  :
from trading.base_trading import BasisTrading
...
class TurnTrade(BasisTrading):
    ...
    def strategy_trade(self, coin_list, momentum_days, user, time_periods, data_limit):
        coin_mom = {}
        for coin_name in coin_list:
            df = self.get_data(coin_name, time_periods, data_limit)
