...
class TwoSmaStrategy(BasisStrategy):
    ...
    def cal_technical_index(self):
        ...
        self.mon_short = bt.talib.ROCP(self.datas[0].close, timeperiod=self.params.short_period)
        self.mon_long = bt.talib.ROCP(self.datas[0].close, timeperiod=self.params.long_period)
